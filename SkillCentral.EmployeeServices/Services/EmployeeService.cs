...
{
    public class EmployeeService(IRepository repository, IMapper mapper, ILogger<EmployeeService> logger, IHttpContextAccessor context) : ServiceBase(context), IEmployeeService
    {
